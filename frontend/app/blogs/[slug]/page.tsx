            ...
            <div className="mb-6 sm:mb-8 rounded-lg border border-[#E5DED1] bg-[#FAF9F6] p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 sm:items-start">
                ...
                <div className="min-w-0 flex-1 text-center sm:text-left">
                  <p className="text-[10px] sm:text-xs font-semibold tracking-[0.2em] text-[#A89878] uppercase mb-1">
                    Written by
                  </p>
                  <h2 className="text-lg sm:text-xl font-serif font-bold text-gray-900 mb-1">Himanshu Bamola</h2>
                  <p className="text-sm text-gray-500 italic leading-snug mb-3">
                    Founder &amp; Principal Analyst, SuperLuxeRE · 16+ years in ultra-luxury real estate strategy
                  </p>
                  <p className="text-sm text-gray-700 leading-relaxed mb-4">
                    Himanshu advises HNIs, NRIs, and family offices on India&apos;s most complex luxury real estate
                    decisions — from Golf Course Road to Worli. His market analysis is trusted by buyers across
                    Singapore, Dubai, London, and the US.
                  </p>
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-6 gap-y-2">
                    <NewTabLink
                      href="https://www.linkedin.com/company/superluxere"
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {relatedPosts.map((related) => {
              ...
              return (
                <NewTabLink key={related.id} href={`/blogs/${related.slug}`} className="group block">
