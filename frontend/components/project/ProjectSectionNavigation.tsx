  ...
  return (
    <section className="sticky top-16 lg:top-20 z-40 bg-[#1A1A2E] border-b border-gray-800 shadow-lg">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto overscroll-x-contain py-3 sm:py-5 scrollbar-hide [-webkit-overflow-scrolling:touch] snap-x snap-mandatory">
