...
export const metadata: Metadata = {
  title: 'About Us - Luxury Real Estate Experts | Opulnz Abode',
  description: 'Discover Opulnz Abode - India\'s premier luxury real estate platform. Learn about our mission, values, and commitment to delivering exceptional property experiences.',
  openGraph: {
    title: 'About Us - Luxury Real Estate Experts | Opulnz Abode',
    description: 'Discover Opulnz Abode - India\'s premier luxury real estate platform. Learn about our mission, values, and commitment to excellence.',
    type: 'website',
    url: 'https://opulnzabode.com/about-us',
  },
  alternates: {
    canonical: 'https://opulnzabode.com/about-us',
  },
};
...
const testimonials = [
  {
    ...
    rating: 5,
    date: 'December 2025',
    review: 'Opulnz Abode made our dream of owning a luxury apartment in South Delhi a reality. Their team was professional, knowledgeable, and went above and beyond to ensure we found the perfect property. Highly recommended!',
    avatar: 'AM',
  },
  {
    name: 'Sneha Kapoor',
    ...
    rating: 5,
    date: 'November 2025',
    review: 'Exceptional service from start to finish! The team at Opulnz Abode understood exactly what we were looking for and showed us only properties that matched our criteria. The entire process was smooth and transparent.',
    avatar: 'SK',
  },
  {
    name: 'Rahul Sharma',
    ...
    rating: 5,
    date: 'October 2025',
    review: 'I was impressed by the professionalism and market knowledge of the Opulnz Abode team. They helped me invest in a premium property in Noida and guided me through every legal and financial aspect. Truly trustworthy!',
    avatar: 'RS',
  },
  {
    name: 'Priya Malhotra',
    ...
    rating: 5,
    date: 'September 2025',
    review: 'Outstanding experience! Opulnz Abode helped us find our perfect luxury home in Mumbai. Their attention to detail and commitment to client satisfaction is unmatched. Thank you for making this journey so memorable!',
    avatar: 'PM',
  },
  {
    name: 'Vikram Patel',
  ...
  },
  {
    ...
    rating: 5,
    date: 'July 2025',
    review: 'Opulnz Abode exceeded all our expectations. From the initial consultation to the final handover, everything was handled with utmost care and professionalism. We absolutely love our new home!',
    avatar: 'AS',
  },
];
        ...
        <div className="relative h-full flex items-center justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-6">
              About <span className="text-gold">Opulnz Abode</span>
            </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Founded in 2014, <span className="font-semibold text-gray-900">Opulnz Abode</span> emerged from a simple yet powerful vision: to redefine luxury real estate in India by connecting discerning clients with the most exclusive properties across the nation.
              </p>
              <p>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-8 md:p-10 rounded-2xl border border-gray-800">
            ...
            <p className="text-gray-300 leading-relaxed">
              To be recognized as India's most trusted and innovative luxury real estate platform, setting new standards in property curation, client service, and market intelligence. We envision a future where every luxury home seeker's journey begins and ends with Opulnz Abode.
            </p>
          </div>
        </div>
      </section>
